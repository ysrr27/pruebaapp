...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__list__ = __webpack_require__(2152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_course_picker_menu_course_picker_menu_popover__ = __webpack_require__(976);
...
var AddonCalendarListPage = /** @class */ (function () {
    ...
    AddonCalendarListPage.prototype.fetchData = function (refresh) {
        ...
        return this.coursesProvider.getUserCourses(false).then(function (courses) {
            ...
            if (_this.preSelectedCourseId) {
                _this.filter.course = courses.find(function (course) {
                    return course.id == _this.preSelectedCourseId;
                });
            }
